...
// COMMENTED OUT - not using database connections right now
// const getSupabase = () => createClient(
//   Deno.env.get('SUPABASE_URL')!,
//   Deno.env.get('SUPABASE_SERVICE_ROLE_KEY')!
// );

// Get all teams - COMMENTED OUT - not using database connections right now
...
// Get all games - COMMENTED OUT - not using database connections right now
...
// Get all venues - COMMENTED OUT - not using database connections right now
...
// Get all tournaments - COMMENTED OUT - not using database connections right now
...
//     if (error) throw error;
//     
//     const tournaments = (leagues || []).map((league: any) => ({
//       id: league.id,
...
//     }
//     
//     return c.json({ providers: providerDetails });
//   } catch (error) {
//     console.error('Error fetching providers:', error);
//     return c.json({ error: 'Failed to fetch providers', details: String(error) }, 500);
//   }
// });
...
//       return c.json({ error: 'No active SportMonks provider found' }, 400);
//     }
//     
...
//     
//     if (!provider?.api_key) {
//       return c.json({ error: 'SportMonks provider not configured' }, 400);
//     }
//     
...
//       return c.json({ error: `SportMonks API error: ${response.status}`, details: errorText.substring(0, 200) }, response.status);
//     }
//     
//     const data = await response.json();
//     return c.json({ ok: true, leagues: data.data || [], subscription: data.subscription, rate_limit: data.rate_limit });
//   } catch (error) {
//     console.error('SportMonks error:', error);
//     return c.json({ error: 'Failed to fetch leagues', details: String(error) }, 500);
//   }
// });
...
//       .from('sports_leagues')
//       .upsert(leagueRecord, { onConflict: 'id' });
//     
//     if (leagueError) {
//       return c.json({ error: 'Failed to save league', details: leagueError.message }, 500);
//     }
//     
//     return c.json({ success: true, leagueId, teamsAdded: 0, message: 'League saved successfully' });
//   } catch (error) {
//     console.error('Error adding league:', error);
//     return c.json({ error: 'Failed to add league', details: String(error) }, 500);
//   }
// });
...
//     
//     if (error) {
//       return c.json({ error: 'Failed to delete teams', details: error.message }, 500);
//     }
//     
//     return c.json({ success: true, leagueId, message: 'League teams removed successfully' });
//   } catch (error) {
//     console.error('Error removing league:', error);
//     return c.json({ error: 'Failed to remove league', details: String(error) }, 500);
//   }
// });
